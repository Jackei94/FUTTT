...
public class GameManager {
    ...
    private final String NON_AVAILABLE__MACRO_CELL = "-";
    ...
    private String playerX = "0"; // 0
    private String playerO = "1"; // 1
    private String DRAW_MARKER = "=";
    ...
    private Boolean verifyMoveLegality(IMove move)
    {
        ...
        boolean isInActivMicroboard = currentState.getField().isInActiveMicroboard(move.getX(), move.getY());
        boolean isAvailable = currentState.getField().getPlayerId(move.getX(), move.getY()).equals(IField.EMPTY_FIELD);
        
        return isInActivMicroboard && isAvailable;
    }
    ...
    private void updateMicroboardState(IMove move)
    {
        ...
        int currentplayerConverterX = 0;
        int currentplayerConverterO = 1;
    ...
    {
        return ((board[startingX][startingY].equals(playerX) || board[startingX][startingY].equals(playerO))
    ...
    {
        if((board[startingX][startingY].equals(playerX) || board[startingX][startingY].equals(playerO))
        ...
        else if((board[startingX][startingY+2].equals(playerX) || board[startingX][startingY+2].equals(playerO))
